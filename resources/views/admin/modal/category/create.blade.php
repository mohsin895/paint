    ...
    <div class="modal fade" id="kt_modal_category_edit{{$row->id}}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" method="post" @if(empty($row->id)) action="{{route('admin.category.insert')}}" @else
                    action="{{route('admin.category.insert',$row->id)}}" @endif id="kt_modal_category_form"
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_category_scroll" data-kt-scroll="true"
                            ...
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    data-kt-ecommerce-order-filter="module" name="module_id" required>
                                    <option>Select Module Name</option>
                                    @foreach($module as $mod)
                                    <option value="{{$mod->id}}" @if(empty($row->id)) @else @if($row->module_id ==
                                        $mod->id) selected="" @endif @endif>{{$mod->module_name}}</option>
                                    @endforeach
                            ...
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="category_name"
                                    @if(empty($row->id)) @else value="{{$row->category_name}}" @endif required />
                                <!--end::Input-->
                            </div>
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body text-center pt-0">
                                        ...
                                        <div class="image-input image-input-empty image-input-outline mb-3"
                                            ...
                                            url({{asset('public/assets/images/category/'.$row->category_image)}})"@endif>
