                                            ...
                                            <div class="row">
                                                <h4 class="fw-boldest text-gray-800 fs-2qx pe-5 pb-0 text-center">
                                                    ...
                                                    <span class="fs-2"> <span class="text-muted">Order
                                                            ID</span> #{{$order->random_order_id}}</span>
                                                </h4>
                                                ...
                                                <div class="col-6 col-lg-6 col-md-6 col-sm-6" style="text-align: left;">

                                                    <img alt="Logo"
                                                        src="{{asset('public/assets/images/setting/'.$gs->site_logo)}}"
                                                        class="w-30" style="" /></br>
                                                    {{$gs->site_title}}, <br>{{$gs->mobile}}<br><br><br>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex flex-column gap-7 gap-md-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6 col-lg-6 col-md-6 col-sm-6">
                                                            ...
                                                            <span class="fs-5">{{$order->phone}}</span> <br>

                                                            <span class="text-muted">Billing Address</span></br>
                                                            <span class="fs-6">{{$user->address}},
                                                                <br />{{$user->email}},
                                                             </span>
                                                ...
                                                <div class="d-flex justify-content-between flex-column">
                                                    ...
                                                    <!--end::Product-->
                                                    <!--begin::SKU-->
                                                    <td class="text-end pb-0 pt-0">{{$row->color}}</td>
                                                    <!--end::SKU-->
                                                    <!--begin::Quantity-->
                                                    @php
                                                    ...
                                                    <!--begin::Grand total-->
                                                    <tr>
                                                        <td colspan="3" class="fs-3 text-dark fw-bolder text-end">Grand
                                                            Total</td>
