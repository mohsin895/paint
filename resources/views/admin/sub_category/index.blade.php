    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card card-flush">
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                @include('admin.modal.subcategory.create')
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">SubCategory Image</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            @php
                            $Categorymodule = App\Models\Category::find($row->category_id);
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!empty($Categorymodule)) {{ $Categorymodule->category_name}} @else @endif
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1"
                                                data-kt-ecommerce-category-filter="subcat_name">{{ $row->subcat_name}}</a>
                                ...
                                <td>
                                    ...
                                    <a href="#" class=" symbol symbol-50px" data-bs-toggle="modal"
                                        ...
                                        <span class="symbol-label"
                                            style="background-image:url({{asset('public/assets/images/subcategory/'.$row->subcategory_image)}}); width:300px;height:100px"></span>
                                    </a>
                                </td>
