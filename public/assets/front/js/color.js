...
$('document').ready( function () {
  ...
  if($('#bxminilogin').length > 0) {
    $('#bxminiloginuser').keypress(function(e){
	  ...
	  if (e.which == 13){$('#bxminilogin').submit();e.preventDefault();return false;}
    });
...
function processFormDataExt( typ, sorte, groesse, farbe, menge, farbname, flag, mengeInhalt, kollektion,colorId) {
  ...
  if(typ=='addWare' || typ=='getPrice') {
    ...
    ajdata = {eID: "bxAjaxOnlineShop", type: typ, sorte: sorte, groesse: groesse, farbe: farbe, kollektion:kollektion, menge: menge,mengeInhalt: mengeInhalt, flag: flag};
	...
	ajdata = {farbname: farbname, eID: "bxAjaxOnlineShop", type: typ, sorte: sorte, groesse: groesse, farbe: farbe, kollektion:kollektion, menge: menge,mengeInhalt: mengeInhalt, flag: flag};
  }
...
// 	bxpageconfll["fav_tree_newfolder"] = "Add folder";  
// 	bxpageconfll["buttonfavcreate"] = "Next"; 
// 	bxpageconfll["labelfavcreate"] = "Name of the favorite"; 
// }
...
$(document).ready(function() {
    ...
    onAdvanced:				function() {$('#gdpr-cookie-accept').text(cookiell["acceptselected"] );},				
	delay: 500,
...
Version 20170227*/
/* 
Scala select, data only
lastchange sb4910 20151117 neue texte
*/

//Conf Array, default values
if(typeof(bxscsConf)=="undefined") {
var bxscsConf =new Array();
//conf vars in order to disable links in certain languages
bxscsConf["showcolordesignerlink"]  = true;
bxscsConf["showsampleservicelink"]  = true;
bxscsConf["showcolorsearchlink"]  = true;
}

//Scala Select Lang Array, default language german
if(typeof(bxscsLang)=="undefined") {
var bxscsLang =new Array();

bxscsLang["colorshade"]  		= "Farbton";
bxscsLang["skhead"]      		= "Stilkarten";
bxscsLang["fshead"]      		= "Farbtonstreifen";
bxscsLang["notfound"]   		= "Es wurden leider keine hinterlegten Farbwerte gefunden.";
bxscsLang["detailview"]    		= "Details";
bxscsLang["tocolordesigner"]  	= "Zum Farbdesigner";
bxscsLang["totechniques"] = "Zu den Ausführungstechniken";
bxscsLang["colordesignerlink"]  = "https://www.farbdesigner.de/web/#project/color/sample/";
bxscsLang["colordesignerlink2"]	= "/e95513/539864f851b6138e5c0cc265";
bxscsLang["cmlink"]  = "https://www.brillux.de/anwendungen/innenraumgestaltung/kreativtechniken/metallische-wandgestaltung/";
bxscsLang["tosampleservice"]  	= "Zum Musterservice";
bxscsLang["sampleservicelink"] 	= "/musterservice/";
bxscsLang["tocolorsearch"]    	= "Zur Farbtonsuche";
bxscsLang["colorsearchlink"]    = "/index.php?id=417";
bxscsLang["fspage"]    		= "Seite";
bxscsLang["rgb"]    		= "RGB";
bxscsLang["rgbdesc"]    	= "Die Bezeichnung RGB steht für die drei Grundfarben Rot, Grün und Blau im RGB-Farbraum, dem additiven Farbsystem für die digitale Farbübermittlung.";
bxscsLang["cmyk"]    		= "CMYK";
bxscsLang["cmykdesc"]    	= "CMY ist die Abkürzung für die subtraktiven Grundfarben Cyan, Magenta und Yellow im CMY-Farbraum. Für den Vierfarbdruck wird zur Erreichung der Farbtiefen außerdem die Farbe Schwarz (Abkürzung K) benötigt.";
bxscsLang["hbw"]    		= "HBW";
bxscsLang["hbwdesc"]    	= "Der Hellbezugswert (HBW) ist Ausdruck für die Helligkeit einer Körperfarbe, wie sie das menschliche Auge in Relation zu Reinweiß (HBW 100) bzw. Tiefschwarz (HBW 0) sieht.";
bxscsLang["metallicdesc"]   = "metallisch-changierender Farbton";
bxscsLang["changebgcolor"]   = "Hintergrundfarbe ändern";
bxscsLang["cmhint1"]   = "Der Farbton";
bxscsLang["cmhint2"]   = "ist Bestandteil des Farbfächers Metallische Wandgestaltung.";
bxscsLang["cmhint1b"]   = "Die Farbtöne";
bxscsLang["cmhint2b"]   = "sind Bestandteil des Farbfächers Metallische Wandgestaltung.";

bxscsLang["fsscsgroup1"]  = "Balance";
bxscsLang["fsscsgroup2"]  = "Dynamik";
bxscsLang["fsscsgroup3"]  = "Eleganz";
bxscsLang["fsscsgroup4"]  = "Nuance";
bxscsLang["fsscsgroup5"]  = "Klassik";
bxscsLang["fsscsgroup6"]  = "Tradition";
bxscsLang["fsscsgroup7"]  = "Terrain";

bxscsLang["skhead0101"]  = "Sommerliches Gelb";
bxscsLang["skdesc0101"]  = "Licht, Wärme und Heiterkeit für gesellige Räume das ganze Jahr: Holen Sie sich die Sonne, die nie untergeht, in Ihr Zuhause. In genau dem Gelbton, der perfekt zu Ihren vier Wänden passt.";
bxscsLang["skhead0102"]  = "Extravagantes Violett";
bxscsLang["skdesc0102"]  = "Originell, fast mystisch, immer magisch: Diese Farbtöne zaubern feinsinnige Inspiration und ein stolzes Ambiente in Ihre Räume. Ein wunderbares Farbspektrum für Individualisten mit Tiefgang.";
bxscsLang["skhead0103"]  = "Träumerisches Pastell";
bxscsLang["skdesc0103"]  = "Zart, luftig und leise: Für eine weiche Raumwirkung mit eigener Handschrift kommen diese pudrigen Farbtöne genau richtig. Die hellen, pastelligen Töne sind immer eine Wohltat fürs Auge.";
bxscsLang["skhead0104"]  = "Stilvolles Grau";
bxscsLang["skdesc0104"]  = "Individuell und höchst persönlich: Diese feinfarbigen Grautöne verströmen Eleganz und ausgesuchten Geschmack. Die edle Ausstrahlung der Farbtöne schafft ganz nebenbei noch mehr: Harmonie.";
bxscsLang["skhead0105"]  = "Prächtiges Rot";
bxscsLang["skdesc0105"]  = "Farben voller Kraft, Würde und Noblesse, einzigartig energiegeladen und beeindruckend sinnlich: Diese Töne begeistern alle, die einen dynamischen, leidenschaftlichen Wohnstil lieben.";
bxscsLang["skhead0106"]  = "Klares Blau";
bxscsLang["skdesc0106"]  = "Macht den Kopf frei, lässt tief durchatmen und öffnet Horizonte: Diese puren, modernen Blautöne machen einen Raum zum Refugium. Zu einem Ort, an dem sich entschleunigen lässt und Stress keine Chance hat.";
bxscsLang["skhead0107"]  = "Behagliches Braun";
bxscsLang["skdesc0107"]  = "Charmant wie edle Hölzer und sinnlich wie der Duft von Kaffee und Kakao: Diese Braunnuancen verbinden Wärme mit starker Ausstrahlung. Ideal für ein stilbewusstes Ambiente mit Kuschelfaktor.";
bxscsLang["skhead0108"]  = "Frühlingshaftes Grün";
bxscsLang["skdesc0108"]  = "So lebendig, so zuversichtlich, so frisch: Mit diesen Farbtönen setzen Sie vitale Akzente und holen sich positive Energie in Ihre Räume. Auf ganz natürliche Art.";
bxscsLang["skhead0109"]  = "Nordisches Petrol";
bxscsLang["skdesc0109"]  = "Eine kühle Schönheit, ein lieblicher Ruhepol, ein trendiger Spaßbringer: Entdecken Sie diese attraktive Farbstimmung für sich. Eine frische Brise Skandinavien für Ihr Zuhause – modern und ausdrucksstark.";
bxscsLang["skhead0110"]  = "Harmonisches Beige";
bxscsLang["skdesc0110"]  = "Ein Ruhestifter mit Flair und Eleganz: Genießen Sie die aktuellen, sandigen Farbtöne und ihren ausgewogenen Gleichklang für die Sinne. Mit diesen zarten Beigetönen, die erden und sanft beleben.";

bxscsLang["skhead0111"]  = "Selbstbewusstes Pink";
bxscsLang["skdesc0111"]  = "Hallo süßes Leben: Pretty in Pink mit Schmelz und Biss, offen für die Welt da draußen, positiv und voller Pläne. Entscheiden Sie sich für die lebensfrohe Art zu wohnen!";
bxscsLang["skhead0112"]  = "Farbiges Weiß";
bxscsLang["skdesc0112"]  = "Weiches Licht, das durch Ihre Räume fließt. Weiß mit einem Hauch von Farbe wie schimmerndes Perlmutt. Hell und leicht, aber mit Charakter!";
bxscsLang["skhead0113"]  = "Nächtliches Blau";
bxscsLang["skdesc0113"]  = "Geheimnisvoll wie die Tiefsee, still wie der Sternenhimmel, unendlich wie das grenzenlose Weltall. Geben Sie meditativer Ruhe Raum – in wunderschönen dunklen Blautönen.";
bxscsLang["skhead0114"]  = "Erdiges Siena";
bxscsLang["skdesc0114"]  = "Wärmende Sonne, schattige Gassen, Mauern voller Kunst und Geschichten: Diese Farbtöne atmen Toskana, uralte Traditionen und raffiniertes Lebensgefühl. Zum Genießen.";
bxscsLang["skhead0115"]  = "Geradliniges Graphit";
bxscsLang["skdesc0115"]  = "Souverän, weil reduziert. Erlesen, weil distanziert. Eine hintergründige Kulisse für Puristen mit klarer Kante und dem Sinn für das Besondere.";

bxscsLang["skhead0116"]  = "Vertrautes Vintage";
bxscsLang["skdesc0116"]  = "Schmeckt nach Milchbar und Diner, klingt wie Swing und Rock ’n’ Roll, entführt Sie sanft in eine heitere Farbwelt voller pudriger Patina. Für Menschen von heute mit Sinn für gestern.";
bxscsLang["skhead0117"]  = "Glamouröser Samt";
bxscsLang["skdesc0117"]  = "Ein einzelner opulenter Akzent, eine ganze barocke Wohnlandschaft, doch immer eine grandiose Wahl. Adeln Sie Ihr Ambiente mit diesen gewichtigen, weichen Farbnuancen.";
bxscsLang["skhead0118"]  = "Fernöstliches Gelb";
bxscsLang["skdesc0118"]  = "Wie Safran und Kurkuma auf der Zunge. Wie friedliche Abendsonne im Herzen. Schwelgen Sie in diesem aromatischen, von asiatischer Weisheit inspirierten Farbkanon.";
bxscsLang["skhead0119"]  = "Vornehmes Taupe";
bxscsLang["skdesc0119"]  = "Ein elementares Seherlebnis: Variationen von Graubraun, überschimmert durch einen warmen Farbhauch. Leben in Taupe, das ist Savoir-vivre in feinster und angemessenster Form.";
bxscsLang["skhead0120"]  = "Charmantes Grün";
bxscsLang["skdesc0120"]  = "Rendezvous von purem Licht und verhaltener Wärme, kristallinem Schillern und verhülltem Leuchten: Inspirierend wie die Metamorphose des matten Halbedelsteines Olivin zum brillanten Peridot.";
...
//bx scala select Stilkarten
var bxscslsk = new Array()
bxscslsk["0101"] = {
	colors:new Array("06.21.12","03.15.06","12.21.12"),
	images:new Array({src:"bxscslsk0101.jpg",alt:bxscsLang["skhead0101"]})	
};
bxscslsk["0102"] = {
	colors:new Array("45.18.30","42.21.24","45.18.27"),
	images:new Array({src:"bxscslsk0102.jpg",alt:bxscsLang["skhead0102"]})
};
bxscslsk["0103"] = {
	colors:new Array("36.09.09","24.12.03","51.15.09"),
	images:new Array({src:"bxscslsk0103.jpg",alt:bxscsLang["skhead0103"]})
};
bxscslsk["0104"] = {
	colors:new Array("36.03.15","99.00.12","48.06.18"),
	images:new Array({src:"bxscslsk0104.jpg",alt:bxscsLang["skhead0101"]})
};
bxscslsk["0105"] = {
	colors:new Array("33.18.27","30.18.24","30.18.27"),
	images:new Array({src:"bxscslsk0105.jpg",alt:bxscsLang["skhead0105"]})	
}; 
bxscslsk["0106"] = {
	colors:new Array("63.18.18","66.15.09","60.21.24"),
	images:new Array({src:"bxscslsk0106.jpg",alt:bxscsLang["skhead0106"]})
};
bxscslsk["0107"] = {
	colors:new Array("18.09.21","15.06.15","15.06.27"),
	images:new Array({src:"bxscslsk0107.jpg",alt:bxscsLang["skhead0107"]})
};
bxscslsk["0108"] = {
	colors:new Array("87.18.18","87.15.12","84.21.21"),
	images:new Array({src:"bxscslsk0108.jpg",alt:bxscsLang["skhead0108"]})
};
bxscslsk["0109"] = {
	colors:new Array("72.18.21","69.21.15","69.24.24"),
	images:new Array({src:"bxscslsk0109.jpg",alt:bxscsLang["skhead0109"]})
};
bxscslsk["0110"] = {
	colors:new Array("12.06.12","12.09.09","09.09.09"),
	images:new Array({src:"bxscslsk0110.jpg",alt:bxscsLang["skhead0110"]})
};
bxscslsk["0111"] = {
	colors:new Array("36.15.21","36.15.24","36.12.21"),
	images:new Array({src:"bxscslsk0111.jpg",alt:bxscsLang["skhead0111"]})
};
bxscslsk["0112"] = {
	colors:new Array("75.03.03","60.09.03","36.03.03"),
	images:new Array({src:"bxscslsk0112.jpg",alt:bxscsLang["skhead0112"]})
};
bxscslsk["0113"] = {
	colors:new Array("57.12.33","54.12.27","57.09.36"),
	images:new Array({src:"bxscslsk0113.jpg",alt:bxscsLang["skhead0113"]})
};
bxscslsk["0114"] = {
	colors:new Array("27.13.24","24.12.18","30.12.27"),
	images:new Array({src:"bxscslsk0114.jpg",alt:bxscsLang["skhead0114"]})
};
bxscslsk["0115"] = {
	colors:new Array("60.06.27","72.06.30","42.03.27"),
	images:new Array({src:"bxscslsk0115.jpg",alt:bxscsLang["skhead0115"]})
};

bxscslsk["0116"] = {
	colors:new Array("96.18.01","45.12.12","69.CM.02"),
	images:new Array({src:"bxscslsk0116.jpg",alt:bxscsLang["skhead0116"]})
};
bxscslsk["0117"] = {
	colors:new Array("72.12.27","36.09.27","42.CM.12"),
	images:new Array({src:"bxscslsk0117.jpg",alt:bxscsLang["skhead0117"]})
};
bxscslsk["0118"] = {
	colors:new Array("03.15.21","06.12.21","03.CM.07"),
	images:new Array({src:"bxscslsk0118.jpg",alt:bxscsLang["skhead0118"]})
};
bxscslsk["0119"] = {
	colors:new Array("42.03.21","18.06.17","99.CM.12"),
	images:new Array({src:"bxscslsk0119.jpg",alt:bxscsLang["skhead0119"]})
};
bxscslsk["0120"] = {
	colors:new Array("81.09.09","87.12.09","87.CM.03"),
	images:new Array({src:"bxscslsk0120.jpg",alt:bxscsLang["skhead0120"]})
};




//bx scala select farbtonstreifen
//farbweltids:
// 1 = Balance
// 2 = Dynamik
// 3 = Eleganz
...
// 6 = Tradition
// 7 = Terrain
var bxscslfs = new Array();
bxscslfs["3150"]={farbwelt:1,colors:new Array("18.09.06","18.09.03","15.03.03","12.15.03","06.12.01"),seite:1};
bxscslfs["3151"]={farbwelt:1,colors:new Array("15.15.03","09.07.03","09.06.06","03.09.01","96.09.03"),seite:2};
bxscslfs["3152"]={farbwelt:1,colors:new Array("15.12.06","03.09.03","03.06.06","03.09.06","06.12.03"),seite:3};
bxscslfs["3153"]={farbwelt:1,colors:new Array("15.09.03","15.12.03","09.09.03","06.15.01","96.18.02"),seite:4};
bxscslfs["3154"]={farbwelt:1,colors:new Array("15.15.06","12.15.06","12.18.02","12.18.03","06.09.06"),seite:5};
bxscslfs["3155"]={farbwelt:1,colors:new Array("15.18.06","09.09.06","09.11.06","06.15.03","03.12.03"),seite:6};
bxscslfs["3156"]={farbwelt:1,colors:new Array("12.12.09","12.12.06","09.15.06","06.12.06","03.15.01"),seite:7};
bxscslfs["3157"]={farbwelt:1,colors:new Array("15.15.09","12.18.07","12.18.09","12.18.06","03.12.06"),seite:8};
bxscslfs["3158"]={farbwelt:1,colors:new Array("15.15.12","12.15.12","09.15.09","09.12.09","96.15.06"),seite:9};
bxscslfs["3159"]={farbwelt:1,colors:new Array("18.12.13","12.15.09","09.18.09","06.12.09","09.12.06"),seite:10};
bxscslfs["3160"]={farbwelt:1,colors:new Array("18.18.12","15.18.09","09.12.12","06.12.12","03.12.09"),seite:11};
bxscslfs["3161"]={farbwelt:1,colors:new Array("18.15.15","15.15.15","12.15.13","09.18.12","06.15.09"),seite:12};
bxscslfs["3162"]={farbwelt:1,colors:new Array("18.15.18","18.18.15","12.18.12","09.21.12","03.15.09"),seite:13};
bxscslfs["3163"]={farbwelt:1,colors:new Array("24.12.16","21.12.15","18.12.09","15.12.09","12.09.06"),seite:14};
bxscslfs["3164"]={farbwelt:1,colors:new Array("27.09.18","24.06.12","24.06.06","21.09.09","21.09.06"),seite:15};
bxscslfs["3165"]={farbwelt:1,colors:new Array("30.09.18","24.12.12","24.12.09","21.12.09","18.12.06"),seite:16};
bxscslfs["3166"]={farbwelt:1,colors:new Array("30.18.15","30.09.15","27.09.12","27.15.06","21.09.03"),seite:17};
bxscslfs["3167"]={farbwelt:1,colors:new Array("36.09.18","36.09.15","30.18.12","27.12.09","24.12.03"),seite:18};
bxscslfs["3168"]={farbwelt:1,colors:new Array("39.15.15","36.09.12","36.09.09","30.15.09","24.12.06"),seite:19};
bxscslfs["3169"]={farbwelt:1,colors:new Array("39.09.18","39.09.15","36.06.12","39.15.09","30.09.06"),seite:20};
bxscslfs["3170"]={farbwelt:1,colors:new Array("42.12.18","42.12.15","39.09.12","39.12.09","36.06.03"),seite:21};
bxscslfs["3171"]={farbwelt:1,colors:new Array("45.18.18","45.18.15","48.12.12","36.09.06","30.15.06"),seite:22};
bxscslfs["3172"]={farbwelt:1,colors:new Array("51.15.21","51.15.15","51.15.12","45.12.12","42.12.09"),seite:23};
bxscslfs["3173"]={farbwelt:1,colors:new Array("51.09.21","51.09.18","51.09.15","45.12.09","36.06.06"),seite:24};
bxscslfs["3174"]={farbwelt:1,colors:new Array("51.12.18","48.09.18","48.09.12","39.09.09","33.12.06"),seite:25};
bxscslfs["3175"]={farbwelt:1,colors:new Array("54.12.18","51.12.15","51.15.09","45.12.06","33.09.12"),seite:26};
bxscslfs["3176"]={farbwelt:1,colors:new Array("57.12.21","54.12.15","54.15.12","54.12.09","54.12.06"),seite:27};
bxscslfs["3177"]={farbwelt:1,colors:new Array("57.15.21","60.12.15","60.15.12","60.12.09","63.09.03"),seite:28};
bxscslfs["3178"]={farbwelt:1,colors:new Array("60.15.18","60.15.15","60.15.09","63.12.06","63.09.06"),seite:29};
bxscslfs["3179"]={farbwelt:1,colors:new Array("63.12.18","63.12.12","63.12.09","63.09.12","66.06.06"),seite:30};
bxscslfs["3180"]={farbwelt:1,colors:new Array("63.15.18","66.12.15","69.12.12","66.12.09","72.09.06"),seite:31};
bxscslfs["3181"]={farbwelt:1,colors:new Array("66.12.18","66.15.09","69.12.09","75.12.06","81.06.03"),seite:32};
bxscslfs["3182"]={farbwelt:1,colors:new Array("72.15.18","75.12.15","75.15.12","78.06.09","78.09.03"),seite:33};
bxscslfs["3183"]={farbwelt:1,colors:new Array("75.15.21","75.15.15","78.09.12","81.09.09","81.09.03"),seite:34};
bxscslfs["3184"]={farbwelt:1,colors:new Array("78.06.18","78.06.15","81.09.12","84.09.09","87.06.03"),seite:35};
bxscslfs["3185"]={farbwelt:1,colors:new Array("81.12.18","81.12.15","84.15.15","84.21.09","84.21.03"),seite:36};
bxscslfs["3186"]={farbwelt:1,colors:new Array("81.09.18","81.12.12","84.15.09","87.15.06","87.09.03"),seite:37};
bxscslfs["3187"]={farbwelt:1,colors:new Array("84.12.18","87.12.12","87.15.09","87.09.06","90.12.06"),seite:38};
bxscslfs["3188"]={farbwelt:1,colors:new Array("87.12.18","87.12.15","87.12.09","90.12.09","87.15.03"),seite:39};
bxscslfs["3189"]={farbwelt:1,colors:new Array("90.09.18","90.09.15","90.12.12","93.12.12","93.15.06"),seite:40};
bxscslfs["3190"]={farbwelt:1,colors:new Array("93.15.21","93.12.18","96.15.09","96.18.03","96.18.01"),seite:41};
bxscslfs["3191"]={farbwelt:2,colors:new Array("03.18.18","03.21.15","03.21.12","03.15.12","03.15.06"),seite:42};
bxscslfs["3192"]={farbwelt:2,colors:new Array("06.12.21","09.21.18","09.24.15","06.21.15","06.21.12"),seite:43};
bxscslfs["3193"]={farbwelt:2,colors:new Array("12.18.18","12.18.15","12.21.15","12.21.12","06.18.12"),seite:44};
bxscslfs["3194"]={farbwelt:2,colors:new Array("18.15.27","15.15.24","15.15.21","12.15.18","12.15.15"),seite:45};
bxscslfs["3195"]={farbwelt:2,colors:new Array("21.18.24","18.21.18","18.24.18","15.21.15","15.18.12"),seite:46};
bxscslfs["3196"]={farbwelt:2,colors:new Array("27.24.24","24.24.21","24.21.18","21.18.21","18.21.15"),seite:47};
bxscslfs["3197"]={farbwelt:2,colors:new Array("21.15.27","21.16.24","21.16.21","21.15.16","18.15.12"),seite:48};
bxscslfs["3198"]={farbwelt:2,colors:new Array("24.15.27","24.18.27","24.15.24","24.12.21","24.12.18"),seite:49};
bxscslfs["3199"]={farbwelt:2,colors:new Array("24.24.24","24.18.24","24.18.23","24.18.18","24.18.15"),seite:50};
bxscslfs["3200"]={farbwelt:2,colors:new Array("27.12.30","27.12.24","27.13.24","24.15.21","24.15.18"),seite:51};
bxscslfs["3201"]={farbwelt:2,colors:new Array("30.18.30","27.18.30","27.24.30","27.21.24","27.21.21"),seite:52};
bxscslfs["3202"]={farbwelt:2,colors:new Array("27.21.27","27.24.27","27.18.24","27.18.21","27.21.18"),seite:53};
bxscslfs["3203"]={farbwelt:2,colors:new Array("33.18.27","30.24.24","30.24.21","30.18.24","30.18.18"),seite:54};
bxscslfs["3204"]={farbwelt:2,colors:new Array("30.15.33","30.12.27","30.18.27","33.15.24","33.12.24"),seite:55};
bxscslfs["3205"]={farbwelt:2,colors:new Array("42.21.27","42.18.27","39.18.24","36.15.24","36.15.21"),seite:56};
bxscslfs["3206"]={farbwelt:2,colors:new Array("36.09.27","36.12.27","36.12.24","36.12.21","42.18.18"),seite:57};
bxscslfs["3207"]={farbwelt:2,colors:new Array("39.12.27","39.15.27","42.21.24","42.18.21","42.21.18"),seite:58};
bxscslfs["3208"]={farbwelt:2,colors:new Array("48.12.27","45.18.27","48.18.24","45.18.24","42.18.24"),seite:59};
bxscslfs["3209"]={farbwelt:2,colors:new Array("48.12.24","48.09.21","39.09.21","33.12.21","30.09.21"),seite:60};
bxscslfs["3210"]={farbwelt:2,colors:new Array("51.12.27","51.15.24","51.12.21","51.12.24","51.09.24"),seite:61};
bxscslfs["3211"]={farbwelt:2,colors:new Array("51.15.30","51.18.27","51.18.24","51.18.21","51.15.18"),seite:62};
bxscslfs["3212"]={farbwelt:2,colors:new Array("54.12.30","54.12.27","54.12.24","54.12.21","60.12.18"),seite:63};
bxscslfs["3213"]={farbwelt:2,colors:new Array("54.15.27","54.15.24","57.21.24","57.21.21","57.21.18"),seite:64};
bxscslfs["3214"]={farbwelt:2,colors:new Array("57.12.27","57.12.24","57.15.24","57.18.24","60.15.21"),seite:65};
bxscslfs["3215"]={farbwelt:2,colors:new Array("57.21.30","57.21.27","60.18.24","60.18.21","60.18.18"),seite:66};
bxscslfs["3216"]={farbwelt:2,colors:new Array("60.18.27","60.15.27","60.15.24","63.18.27","63.15.24"),seite:67};
bxscslfs["3217"]={farbwelt:2,colors:new Array("60.21.27","60.21.24","63.18.24","60.21.21","63.18.18"),seite:68};
bxscslfs["3218"]={farbwelt:2,colors:new Array("63.21.27","66.18.24","66.18.21","66.18.18","66.18.15"),seite:69};
bxscslfs["3219"]={farbwelt:2,colors:new Array("66.12.30","66.15.27","66.18.27","69.15.24","69.12.21"),seite:70};
bxscslfs["3220"]={farbwelt:2,colors:new Array("69.12.27","69.21.27","69.21.24","69.18.21","69.18.18"),seite:71};
bxscslfs["3221"]={farbwelt:2,colors:new Array("69.15.27","69.24.24","69.21.21","69.21.18","69.21.15"),seite:72};
bxscslfs["3222"]={farbwelt:2,colors:new Array("72.12.27","72.12.24","72.12.21","72.12.18","72.12.15"),seite:73};
bxscslfs["3223"]={farbwelt:2,colors:new Array("72.18.27","72.18.24","72.18.21","72.18.18","72.18.15"),seite:74};
bxscslfs["3224"]={farbwelt:2,colors:new Array("75.18.27","75.21.24","78.12.24","78.18.24","78.18.18"),seite:75};
bxscslfs["3225"]={farbwelt:2,colors:new Array("81.18.33","81.18.24","81.18.27","78.15.24","78.12.21"),seite:76};
bxscslfs["3226"]={farbwelt:2,colors:new Array("78.12.27","81.15.24","81.18.21","81.18.18","81.18.15"),seite:77};
bxscslfs["3227"]={farbwelt:2,colors:new Array("84.15.30","84.18.27","84.18.24","84.21.27","84.15.21"),seite:78};
bxscslfs["3228"]={farbwelt:2,colors:new Array("84.15.24","84.21.21","84.21.18","84.21.15","87.15.12"),seite:79};
bxscslfs["3229"]={farbwelt:2,colors:new Array("87.15.21","87.15.18","87.18.18","87.18.15","93.18.15"),seite:80};
bxscslfs["3230"]={farbwelt:2,colors:new Array("96.12.21","96.18.18","90.15.15","90.18.12","93.15.15"),seite:81};
bxscslfs["3231"]={farbwelt:2,colors:new Array("03.15.21","96.18.15","96.21.12","96.24.12","93.18.18"),seite:82};
bxscslfs["3232"]={farbwelt:3,colors:new Array("99.00.21","99.00.18","99.00.15","99.00.12","99.00.09"),seite:83};
bxscslfs["3233"]={farbwelt:3,colors:new Array("03.03.18","03.03.15","03.03.12","03.03.09","03.03.06"),seite:84};
bxscslfs["3234"]={farbwelt:3,colors:new Array("03.06.18","03.06.15","03.06.12","03.06.09","09.09.02"),seite:85};
bxscslfs["3235"]={farbwelt:3,colors:new Array("06.06.15","06.06.12","06.06.09","06.06.06","09.06.03"),seite:86};
bxscslfs["3236"]={farbwelt:3,colors:new Array("09.06.18","09.06.15","09.06.12","09.06.09","09.06.02"),seite:87};
bxscslfs["3237"]={farbwelt:3,colors:new Array("12.03.18","12.03.15","12.03.12","12.03.09","12.03.06"),seite:88};
bxscslfs["3238"]={farbwelt:3,colors:new Array("15.03.24","15.03.21","18.06.17","15.03.09","15.03.06"),seite:89};
bxscslfs["3239"]={farbwelt:3,colors:new Array("15.03.15","15.03.12","09.07.09","09.07.06","09.09.01"),seite:90};
bxscslfs["3240"]={farbwelt:3,colors:new Array("15.09.17","12.09.12","06.09.12","06.09.09","09.09.09"),seite:91};
bxscslfs["3241"]={farbwelt:3,colors:new Array("12.12.12","09.11.15","09.11.12","12.09.09","18.09.09"),seite:92};
bxscslfs["3242"]={farbwelt:3,colors:new Array("12.06.12","15.06.12","15.06.09","15.06.06","15.06.03"),seite:93};
bxscslfs["3243"]={farbwelt:3,colors:new Array("12.09.15","15.09.15","15.09.12","15.09.09","15.09.06"),seite:94};
bxscslfs["3244"]={farbwelt:3,colors:new Array("15.06.18","15.06.15","18.06.12","18.06.09","18.06.06"),seite:95};
bxscslfs["3245"]={farbwelt:3,colors:new Array("24.06.18","24.06.15","21.09.15","21.09.12","27.09.03"),seite:96};
bxscslfs["3246"]={farbwelt:3,colors:new Array("33.09.17","33.06.17","18.06.15","24.06.09","24.06.03"),seite:97};
bxscslfs["3247"]={farbwelt:3,colors:new Array("30.06.18","30.06.15","30.06.12","30.06.09","30.06.06"),seite:98};
bxscslfs["3248"]={farbwelt:3,colors:new Array("39.06.18","39.06.15","39.06.12","39.06.09","39.06.06"),seite:99};
bxscslfs["3249"]={farbwelt:3,colors:new Array("33.06.18","33.06.15","33.06.12","33.06.09","33.06.06"),seite:100};
bxscslfs["3250"]={farbwelt:3,colors:new Array("36.03.18","36.03.15","36.03.12","36.03.09","36.03.06"),seite:101};
bxscslfs["3251"]={farbwelt:3,colors:new Array("42.03.21","42.03.15","42.03.12","42.03.06","45.06.03"),seite:102};
bxscslfs["3252"]={farbwelt:3,colors:new Array("45.06.18","45.06.15","45.06.12","45.06.09","45.06.06"),seite:103};
bxscslfs["3253"]={farbwelt:3,colors:new Array("48.06.21","48.06.18","48.06.15","48.06.12","48.06.09"),seite:104};
bxscslfs["3254"]={farbwelt:3,colors:new Array("51.06.21","51.06.18","51.06.15","51.06.12","51.06.09"),seite:105};
bxscslfs["3255"]={farbwelt:3,colors:new Array("57.06.21","57.06.18","57.06.15","57.06.12","63.06.03"),seite:106};
bxscslfs["3256"]={farbwelt:3,colors:new Array("60.09.18","60.09.15","60.09.12","60.09.09","60.09.06"),seite:107};
bxscslfs["3257"]={farbwelt:3,colors:new Array("60.06.19","60.06.18","60.06.12","60.06.09","60.06.06"),seite:108};
bxscslfs["3258"]={farbwelt:3,colors:new Array("42.03.27","51.03.24","63.03.18","60.06.15","75.03.12"),seite:109};
bxscslfs["3259"]={farbwelt:3,colors:new Array("66.06.24","66.06.21","66.06.15","66.06.12","66.06.03"),seite:110};
bxscslfs["3260"]={farbwelt:3,colors:new Array("66.09.18","66.09.15","66.09.12","63.12.03","66.03.03"),seite:111};
bxscslfs["3261"]={farbwelt:3,colors:new Array("66.03.18","66.03.15","66.03.12","66.03.09","66.03.06"),seite:112};
bxscslfs["3262"]={farbwelt:3,colors:new Array("69.03.18","69.03.15","69.03.12","69.03.09","69.03.06"),seite:113};
bxscslfs["3263"]={farbwelt:3,colors:new Array("75.06.18","75.06.15","75.06.12","75.06.09","75.06.06"),seite:114};
bxscslfs["3264"]={farbwelt:3,colors:new Array("78.03.18","78.03.15","78.03.12","78.03.09","78.03.06"),seite:115};
bxscslfs["3265"]={farbwelt:3,colors:new Array("78.01.18","78.01.15","78.01.12","78.01.09","78.01.06"),seite:116};
bxscslfs["3266"]={farbwelt:3,colors:new Array("81.03.18","81.03.15","81.03.12","81.03.09","81.03.06"),seite:117};
bxscslfs["3267"]={farbwelt:3,colors:new Array("81.06.21","81.06.18","81.06.15","81.06.12","81.06.09"),seite:118};
bxscslfs["3268"]={farbwelt:3,colors:new Array("84.09.27","84.06.21","84.06.18","84.06.12","84.06.06"),seite:119};
bxscslfs["3269"]={farbwelt:3,colors:new Array("87.03.18","87.03.15","87.03.12","87.03.09","87.03.06"),seite:120};
bxscslfs["3270"]={farbwelt:3,colors:new Array("90.03.19","90.03.18","90.03.15","90.03.09","90.03.06"),seite:121};
bxscslfs["3271"]={farbwelt:3,colors:new Array("90.06.18","90.06.15","90.06.12","90.06.09","90.06.06"),seite:122};
bxscslfs["3272"]={farbwelt:3,colors:new Array("93.03.21","93.06.24","93.03.18","93.03.15","93.03.09"),seite:123};
bxscslfs["3273"]={farbwelt:4,colors:new Array("12.03.03","42.03.03","78.01.03","96.12.01","15.15.01"),seite:124};
bxscslfs["3274"]={farbwelt:4,colors:new Array("93.03.06","87.03.03","81.03.03","75.03.03","69.03.03"),seite:125};
bxscslfs["3275"]={farbwelt:4,colors:new Array("03.03.03","06.06.03","18.06.03","33.06.03","60.09.03"),seite:126};
bxscslfs["3276"]={farbwelt:4,colors:new Array("84.06.03","57.06.03","45.09.06","36.03.03","99.00.03"),seite:127};
bxscslfs["3277"]={farbwelt:5,colors:new Array("30.06.30","18.06.27","42.03.30","99.00.60","72.06.30"),seite:128};
bxscslfs["3278"]={farbwelt:5,colors:new Array("39.06.30","90.06.33","03.03.30","12.09.30","15.06.30"),seite:129};
bxscslfs["3279"]={farbwelt:5,colors:new Array("36.09.36","36.06.33","27.09.33","27.09.30","24.18.30"),seite:130};
bxscslfs["3280"]={farbwelt:5,colors:new Array("36.09.33","36.09.30","30.09.30","30.12.30","30.18.33"),seite:131};
bxscslfs["3281"]={farbwelt:5,colors:new Array("99.00.69","18.06.33","48.09.30","48.15.33","45.18.30"),seite:132};
bxscslfs["3282"]={farbwelt:5,colors:new Array("57.09.36","57.12.33","60.12.30","60.15.30","66.15.30"),seite:133};
bxscslfs["3283"]={farbwelt:5,colors:new Array("66.06.30","66.09.30","72.15.30","69.12.30","72.09.27"),seite:134};
bxscslfs["3284"]={farbwelt:5,colors:new Array("81.03.33","81.06.30","81.09.30","87.12.27","84.12.30"),seite:135};
bxscslfs["3285"]={farbwelt:6,colors:new Array("99.00.51","99.00.45","99.00.39","99.00.30","99.00.24"),seite:136};
bxscslfs["3286"]={farbwelt:6,colors:new Array("12.03.27","12.03.24","12.03.21","12.03.19","03.03.16"),seite:137};
bxscslfs["3287"]={farbwelt:6,colors:new Array("60.06.30","60.06.27","60.06.24","60.06.21","60.03.24"),seite:138};
bxscslfs["3288"]={farbwelt:6,colors:new Array("75.03.27","75.03.24","75.03.21","75.03.18","75.03.15"),seite:139};
bxscslfs["3289"]={farbwelt:6,colors:new Array("78.01.30","78.01.27","78.01.24","78.01.21","81.03.16"),seite:140};
bxscslfs["3290"]={farbwelt:7,colors:new Array("06.09.27","90.09.24","03.09.24","06.12.24","06.15.21"),seite:141};
bxscslfs["3291"]={farbwelt:7,colors:new Array("03.06.30","03.06.27","03.06.24","03.06.21","03.06.16"),seite:142};
bxscslfs["3292"]={farbwelt:7,colors:new Array("15.06.24","12.06.24","12.06.21","12.06.18","12.06.15"),seite:143};
bxscslfs["3293"]={farbwelt:7,colors:new Array("09.06.24","12.09.27","12.09.24","12.09.21","12.09.18"),seite:144};
bxscslfs["3294"]={farbwelt:7,colors:new Array("12.12.27","12.12.24","12.12.21","12.12.18","12.12.15"),seite:145};
bxscslfs["3295"]={farbwelt:7,colors:new Array("15.12.27","15.12.24","15.12.21","15.12.18","15.12.15"),seite:146};
bxscslfs["3296"]={farbwelt:7,colors:new Array("18.09.27","18.09.24","18.09.21","18.09.18","18.09.15"),seite:147};
bxscslfs["3297"]={farbwelt:7,colors:new Array("15.09.30","15.09.27","15.09.24","15.09.21","15.09.18"),seite:148};
bxscslfs["3298"]={farbwelt:7,colors:new Array("24.09.30","21.09.27","21.09.24","21.09.21","21.09.18"),seite:149};
bxscslfs["3299"]={farbwelt:7,colors:new Array("15.06.27","21.06.30","21.06.27","21.06.24","21.06.21"),seite:150};
//EOF
/*
Webview scala color family
requires: jquery, getUrlParam.js, 
requires: element with id #bx-color-scala
requires data arrays:  bxscar
lastchanges 20171011 sb4910
*/

/*Plugin scalaFamilyView*/
(function($) {
	$.fn.scalaFamilyView = function(options) {
		//Default Settings
		 var settings = $.extend({
			action:	"",
			mode: "",
			pid: "",
			colorlist: "",
			showspecials:false, //show LA or ME shades?
			ll: {
				back:'',
				fdlinklabel:'',
				fdlink:'http://localhost/brillux/color-shades/color-shades',
				rgb:'RGB',
				rgbdesc:'Die Bezeichnung RGB steht für die drei Grundfarben Rot, Grün und Blau im RGB-Farbraum, dem additiven Farbsystem für die digitale Farbübermittlung.',
				cmyk:'CMYK',
				cmykdesc:'CMY ist die Abkürzung für die subtraktiven Grundfarben Cyan, Magenta und Yellow im CMY-Farbraum. Für den Vierfarbdruck wird zur Erreichung der Farbtiefen außerdem die Farbe Schwarz (Abkürzung K) benötigt.',
				hbw:'HBW',
				hbwdesc:'Der Hellbezugswert (HBW) ist Ausdruck für die Helligkeit einer Körperfarbe, wie sie das menschliche Auge in Relation zu Reinweiß (HBW 100) bzw. Tiefschwarz (HBW 0) sieht.'
			}
		}, options);	

		setScalaFamilyViewColorPreview = function(name,rgb,cmyk, hbz) {
			$('#colorpreviewbox').hide();
			$('.bxcolorpreviewarea').css('background-color','rgb'+rgb);
			$('.bxcolorpreviewtitle').html('Scala '+name+'<br /><abbr title="'+settings.ll.rgbdesc+'">'+settings.ll.rgb+'</abbr>: '+rgb+'<br /><abbr title="'+settings.ll.cmykdesc+'">'+settings.ll.cmyk+'</abbr>: '+cmyk+'<br /><abbr title="'+settings.ll.hbwdesc+'">'+settings.ll.hbw+'</abbr> '+hbz);

			$('#bxcolorpreviewfdlink').html('<a target="_blank" href="'+settings.ll.fdlink+name+'/e95513/539864f851b6138e5c0cc265">'+settings.ll.fdlinklabel+'</a>');
			$('#colorpreviewbox').fadeIn("slow");
			document.location.hash='bx-color-scala-previewimages';
		}

		var htmlmarkup = "";
		
		if(settings.action.length==2) {
			settings.mode="fam";
		} else if(settings.action.length==5) {
			settings.mode="sat";
		}
		

		for (var key in settings.colorlist) {
			if( (settings.mode=="fam" && key.substr(0, 2)==settings.action) ||  settings.mode=="sat" && key.substr(0, 5)==settings.action)  {
				if(settings.showspecials || !key.match(/[^0-9\.]/g)) {
					htmlmarkup += '<a onclick="setScalaFamilyViewColorPreview(\''+key+'\',\''+settings.colorlist[key].rgb+'\',\''+settings.colorlist[key].cmyk+'\',\''+settings.colorlist[key].hbz+'\');" class="col-md-2 col-sm-3 col-xs-3" href="javascript:;"><span style="background-color:rgb'+settings.colorlist[key].rgb+'" title="'+key+'"></span><strong>'+key+'</strong></a>';
				}
			}
		}
		
		htmlmarkup +=  '<div class="clearfix copy"><p><a href="'+getScalaFamilyViewLink('overview',settings.pid)+'">'+settings.ll.back+'</a></p></div>';
		

		htmlmarkup = "<div>"+htmlmarkup+"</div>";
		return htmlmarkup;
	};
}( jQuery ));

getScalaFamilyViewLink = function(scalafam,pid) {
		var url = [location.protocol, '//', location.host, location.pathname].join('');
		return url+"?show="+scalafam+((pid>0)?"&id="+pid:"");
