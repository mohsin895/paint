...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    @php 
$order_user = App\Models\User::find($order->user_id);
    @endphp
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <a href="{{route('admin.order')}}" class="text-muted text-hover-primary">View All Order</a>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card card-flush py-4 flex-row-fluid">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>Order Details (#{{$order->random_order_id}})</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href=""
                                                                ...
                                                                <span class="symbol-label"
                                                                    style="background-image:url({{asset('public/assets/images/product/'.$product->product_image)}});"></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
                                                            <!--begin::Title-->
                                                            <div class="ms-5">
                                                    ...
                                                    <td class="text-end">{{$gs->currency}}&nbsp;&nbsp;{{$row->selling_price}}
                                                    </td>
                                                    <!--end::Price-->
                                                    <!--begin::Total-->
                                                    <td class="text-end">
                                                        {{$gs->currency}}&nbsp;&nbsp;{{$row->selling_price * $row->quantity}}</td>
                                                ...
                                                <tr>
                                                   ...
                                                   <td colspan="4" class="text-end">Vat({{$gs->vat}} %)</td>
                                                   <td class="text-end">
                                                       {{$gs->currency}}&nbsp;&nbsp;{{$order->vat}}
                                                   </td>
                                                ...
                                                <tr>
                                                    <td colspan="4" class="text-end">Shipping
                                                        Charge</td>
                                                    <td class="text-end">
                                                        {{$gs->currency}}&nbsp;&nbsp;{{$order->shipping_charge}}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-dark fs-3 fw-boldest text-end">
                                                        {{$gs->currency}}&nbsp;&nbsp;{{$order->paybale_total}}
                                                    </td>
                                                </tr>
                                                <!--end::Grand total-->
                                                <!--end::Grand total-->
