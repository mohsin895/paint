    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="menu-link px-3 btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_branch">{{$add_title}}</a>
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                @include('admin.modal.branch.branch')
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">Shop Address</th>
                                <th class="min-w-150px">Shop Owner</th>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_branch_edit{{$row->id}}">Edit</a>
                                        </div>

                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="branch" recordid="{{ $row->id }}"
