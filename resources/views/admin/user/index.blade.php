                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Email=-->
                                <td>
                                    <a href="{{route('admin.user',$row->id)}}" class="text-gray-600 text-hover-primary mb-1">{{$row->email}}</a>
                                </td>
                                <td>
                                    <a href="{{route('admin.user',$row->id)}}" class="text-gray-600 text-hover-primary mb-1">{{$row->phone}}</a>
                                </td>
                                <!--end::Email=-->
                                <!--begin::Status=-->
                                <td>
