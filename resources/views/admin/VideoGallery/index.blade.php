    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="menu-link px-3 btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_video">{{$add_title}}</a>
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                @include('admin.modal.video.video')
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_video_edit{{$row->id}}">Edit</a>
                                        </div>

                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="videoGallery" recordid="{{ $row->id }}"
