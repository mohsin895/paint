            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('admin.module')}}" class="text-muted text-hover-primary">{{$table}}</a>
                    </li>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card card-flush">
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                @include('admin.modal.module.create')
                <div class="card-body pt-0 table-responsive">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 " id="kt_ecommerce_category_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1"
                                                data-kt-ecommerce-category-filter="category_name">{{ $row->module_name}}</a>
                            ...
                            data-bs-target="#kt_modal_module_edit{{$row->id}}">Edit</a>
                                        </div>
