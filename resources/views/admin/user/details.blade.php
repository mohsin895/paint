                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="pb-5 fs-6">
                                ...
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">{{$user_details->address}}</div>
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5"
                                        ...
                                        <tbody class="fs-6 fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="{{url('admin/order/details',$row->random_order_id)}}"
                                                        class="text-gray-600 text-hover-primary mb-1">#{{$row->random_order_id}}</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                                ...
                                                <!--end::Status=-->
                                                <!--begin::Amount=-->
                                                <td>{{$gs->currency}} &nbsp;&nbsp;{{$row->paybale_total}}</td>
                                                <!--end::Amount=-->
                                                <!--begin::Amount=-->
