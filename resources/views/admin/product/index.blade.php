            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--begin::Add product-->
                        <a href="{{route('admin.product.insert')}}" class="btn btn-primary">Add
                            Product</a>
                        <!--end::Add product-->
                    </div>
                    <!--end::Card toolbar-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-100px">Color</th>
                          ...
                          @foreach($product as $row)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="{{route('admin.product.insert',$row->id)}}"
                                            ...
                                            <span class="symbol-label"
                                                style="background-image:url({{asset('public/assets/images/product/'.$row->product_image)}});"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                ...
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">{{$row->color}}</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <!--begin::Price=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder text-dark">{{$gs->currency}} {{$row->selling_price}}</span>
                                </td>
                                <!--end::Price=-->
                                <!--begin::Rating-->
